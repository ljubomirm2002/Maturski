...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2020 at 06:37 PM
...
BEGIN
SET @sql='SELECT * FROM users WHERE username=? AND password=? AND deleted=NULL ';
...
(1, 4000, '2020-03-26', 'Izbaciti type_id i transaction_types i gledati da li je user_id source_id ili destination_id?\r\nDa li je moguce da se svi fajlovi uploaduju na server i da dobijemo nalog pa da mozemo to da menjamo i pratimo?', 1, 2, 1, NULL, 2, 1);
...
(4, 'Blank', 'blank', 'pravljenjesajta1@gmail.com', 'O9ocfyzT', 'None', NULL, NULL, 2);
